...
- 2026-09-07: Conclusion amended. The flagship compression claim failed; the combined behavioral claim remains unproven because N2 was never run. Historical comparisons support skepticism, not a category-wide impossibility claim. Archive retained; no grammar or scoring change.
- 2026-07-25: Archive verdict. Viability teardown run 2026-07-25: zero adoption signal across all instruments (0 stars, 0 forks, 5 unique visitors in 14 days, 0 external adopters, package never published); the flagship compression claim failed measurement on 2026-06-18, and the broader advantage remained unvalidated. Verdict: archive as testament. POST-MORTEM.md is the authoritative closing document. N2 (the live A/B kill-criterion) closed unrun; adoption figures informed the investment decision but did not answer the behavioral question (clarified 2026-09-07). tokenese.org stays up.
