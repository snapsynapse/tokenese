...
- 2026-07-25: Archive verdict. Viability teardown run 2026-07-25: zero adoption signal across all instruments (0 stars, 0 forks, 5 unique visitors in 14 days, 0 external adopters, package never published); the founding premise was falsified by measurement on 2026-06-18 and never recovered; the category-wide landscape survey shows no designed agent interlanguage with adoption anywhere in the 70-year lineage. Verdict: archive as testament. POST-MORTEM.md is the authoritative closing document. N2 (the live A/B kill-criterion) closed unrun; the demand evidence answered its question below its resolution. tokenese.org stays up.
